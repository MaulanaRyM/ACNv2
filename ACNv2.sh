...
echo $g "    _________________________________   ${endc}";
echo $g "   /                                 \  ${endc}";
echo $g "  /   https://github.com/MaulanaRyM   \ ${endc}";
echo $g " /_____________________________________\ ${endc}";
echo $g " |      __     ___________     __      | ${endc}";
echo $g " |     |  |    |    |    |    |  |     | ${endc}";
echo $g " |      --     |   .|.   |     --      | ${endc}";
echo $g " ======================================= ${endc}";
...
echo $r"•••••••••••••••••••••••••••••••••••••••••••••••••${endc}";
echo   "##### Kumpulan Tools Terbaru V.2 2018-2019! #####" |lolcat
echo $r"•••••••••••••••••••••••••••••••••••••••••••••••••${endc}";
...
mv jadwal-sholat $HOME
cd $HOME/jadwal-sholat
npm install
node index
...
00) echo "Tq, Bye gan :)" |lolcat
exit

;;

*) echo "Maaf,Pilihan yang anda cari tidak tersedia,Coba yang lain! "
esac
done
done
